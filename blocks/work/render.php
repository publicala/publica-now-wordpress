<?php
/**
 * Server render for the publica-now/work block.
 *
...
echo \PublicaNow\Renderer::instance()->work( $publicanow_atts ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- the Renderer and its templates escape at output.
